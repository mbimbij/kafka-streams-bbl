package com.example.demo.wordcount._4tableToStream;
...
@RestController
public class WordCountGroupByKeyDslTableToStream implements ApplicationRunner {
  ...
  public static void main(String[] args) {
    SpringApplication.run(WordCountGroupByKeyDslTableToStream.class, args);
  }
  ...
  public static Topology getTopology() {
    ...
    builder.<String, String>stream(INPUT_TOPIC)
        ...
        .toStream()
        .to(OUTPUT_TOPIC, Produced.valueSerde(Serdes.Long()));
