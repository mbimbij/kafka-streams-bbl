...
class ToUppercaseLowLevelApiApplicationTests {
	...
	void setUp() {
		...
		testDriver = new TopologyTestDriver(ToUppercaseLowLevelApiApplication.getTopology(), properties);

		// setup test topics
		inputTopic = testDriver.createInputTopic(ToUppercaseLowLevelApiApplication.INPUT_TOPIC, stringSerde.serializer(), stringSerde.serializer());
		outputTopic = testDriver.createOutputTopic(ToUppercaseLowLevelApiApplication.OUTPUT_TOPIC, stringSerde.deserializer(), stringSerde.deserializer());
	}
