...
class WordSplitLowLevelApiApplicationTest {
  ...
  void setUp() {
    ...
    testDriver = new TopologyTestDriver(WordSplitLowLevelApiApplication.getTopology(), properties);

    // setup test topics
    inputTopic = testDriver.createInputTopic(WordSplitLowLevelApiApplication.INPUT_TOPIC, stringSerde.serializer(), stringSerde.serializer());
    outputTopic = testDriver.createOutputTopic(WordSplitLowLevelApiApplication.OUTPUT_TOPIC, stringSerde.deserializer(), stringSerde.deserializer());
  }
